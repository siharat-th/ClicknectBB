...
public class NowShowingView implements ListFieldCallback {
	private Manager manager;
	private ListField listField;
	private Vector listData;
	
	public NowShowingView(ActionScreen parent){
		...
		listField = new ListField(0, Manager.USE_ALL_HEIGHT){
			public boolean navigationClick(int status, int time){
				...
				ProgramData data = (ProgramData)NowShowingView.this.listData.elementAt(index);
